        ...
        <section className="bg-primary/5">
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md'>
                <div className="text-center">
                    <p className='text-orange-800 text-lg font-normal mb-3 tracking-widest uppercase'>MENU</p>
                    <h2 className="text-3xl lg:text-5xl font-semibold text-black dark:text-white">
                        Kue Kering Lebaran 2025 di Jogja – Premium dan Homemade
                    </h2>
                </div>
                <Slider {...settings}>
                    {ExpertData.map((items, i) => (
                        <div key={i}>
                            <div className='m-3 py-14 my-10 text-center'>
                                ...
                                <h4 className='text-lg font-normal text-lightblack pt-4 pb-2 opacity-80'>{items.profession}</h4>
                            </div>
                        </div>
                    ))}
                </Slider>
