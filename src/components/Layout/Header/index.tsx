      ...
      <div className="lg:py-0 py-2">
        <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md flex items-center justify-between px-4">
          ...
          <div className="flex items-end gap-4">
            <Link href="https://wa.me/6281952116486" className="text-lg font-medium hover:text-primary">
              <Icon
            ...
            >
              ...
              <span className="block w-6 h-0.5 bg-slate-500 mt-1.5"></span>
              <span className="block w-6 h-0.5 bg-slate-500 mt-1.5"></span>
            </button>
          </div>
        </div>
        ...
        <div
          ref={mobileMenuRef}
          className={`lg:hidden fixed bg-gray-200/50 backdrop-blur-md top-0 right-0 h-full w-full bg-darkmode shadow-lg transform transition-transform duration-300 max-w-xs ${navbarOpen ? "translate-x-0" : "translate-x-full"
            } z-50`}
        >
          <div className="flex items-center justify-between p-4">
            ...
            <button
              ...
              className="bg-[url('/images/closed.svg')] bg-no-repeat bg-contain w-5 h-5 absolute top-0 right-0 mr-8 mt-8 dark:invert bg-black/80 backdrop-blur-sm rounded-full p-3"
