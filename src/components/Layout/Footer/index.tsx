  ...
  return (
    <footer className="pt-16 bg-darkmode">
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="grid grid-cols-1 sm:grid-cols-5 lg:gap-20 md:gap-6 sm:gap-12 gap-6  pb-16">
          <div className="col-span-2">
            ...
            <p className="text-xs font-medium text-grey dark:text-white/50 mt-5 mb-16 max-w-70%">
              Pesan Kue Kering Lebaran di Chasana Jogja | Kastengel, Nastar, Putri Salju Homemade kualitas premium.
            </p>
            <div className="flex gap-6 items-center">
              <Link href="https://www.instagram.com/hanifahzakiyyah/" aria-label="link to social media kue kering chasana jogja" className="group bg-white hover:bg-primary rounded-full shadow-xl p-3">
                <Icon
        ...
        <div className="border-t border-grey/15 dark:border-white/15 py-10 flex flex-col justify-between items-center">
          <p className="text-sm text-black/70 dark:text-white/70 text-center">
            @2025 - Chasana Cake & Bakery.
          </p>
          <p className="text-sm text-black/70 dark:text-white/70 text-center">
            Developed by <Link href="https://hanifah-portfolio.vercel.app/" className="hover:text-primary">Hanifah Zakiyyah</Link>
          </p>
